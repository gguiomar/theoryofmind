...
plt.subplots_adjust(top=0.88, bottom=0.15, left=0.25, right=0.90)
...
# Set title (positioned lower to make room for idea density)
...
# ax.set_title('Correlation between Idea Density and Performance', 
...
plt.tight_layout()
plt.savefig('idea_density_correlation_seaborn.pdf', dpi=300, bbox_inches='tight')
plt.show()
